...
<body>
	<div class="container-fluid">
		<div class="row top" style="background-color: #604E72">
			<center>
				...
				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> 1247@gmail.com</span>
				</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<div class="row">
					<img src="image/home/beranda.png" alt="" width="21px">
					<b>12.47</b>
				</div>
			</a>
			</div>
