...
<div class="container" style="padding-bottom: 300px;">
	<h2 style=" width: 100%; border-bottom: 4px solid #98639E"><b>Keranjang</b></h2>
				...
				if($jml > 0){
					...
					<?php 
					 ...
					 ?>
						...
						<tr>
						<td colspan='7' class='text-center bg-info'><h5><b>KERANJANG BELANJA ANDA KOSONG </b></h5></td>
						</tr>
					...
					echo "<tr>
					<td colspan='7' class='text-center bg-info'><h5><b>SILAHKAN LOGIN TERLEBIH DAHULU SEBELUM BERBELANJA</b></h5></td>
					</tr>";
				}
				?>
